      ...
      <div class="tile is-parent is-vertical">
        <article class="tile is-child box">
          ...
          <b-collapse class="content card">
            ...
            <div class="card-content" v-else>
              <p>
                The Brand website will send emails to this address. If this is blank,
                the default of <strong>ciscowebexcc@gmail.com</strong> will be used.
              </p>
              <b-field label="Demo Email Address">
                <b-input v-model="model.email" placeholder="ciscowebexcc@gmail.com" />
              </b-field>
              <!-- Save Button -->
              <b-field>
                <button type="button" class="button is-success"
